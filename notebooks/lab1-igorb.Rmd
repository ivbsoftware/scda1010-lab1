...
Another way to estimate accuracy
```{r}
confusion.matrix <- prop.table(table(dtPredictedClass$prediction,dtPredictedClass$original))
confusion.matrix
accuracy <- confusion.matrix[1,1]+confusion.matrix[2,2]+confusion.matrix[3,4]
accuracy
```
