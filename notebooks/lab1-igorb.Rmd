...
```{r}
train.rows<- createDataPartition(y= nursery_data$class, p=0.5, list = FALSE)
train.data<- nursery_data[train.rows,] # 50% data goes in here
prop.table((table(train.data$class)))
```

Now creating and checking the test set
```{r}
test.data<- nursery_data[-train.rows,] # 50% data goes in here
