...
```{r}
train.rows<- createDataPartition(y= nursery_data$class, p=0.7, list = FALSE)
train.data<- nursery_data[train.rows,] # 70% data goes in here
prop.table((table(train.data$class)))
```

Now creating and checking the test set containing 25% of the data
```{r}
test.data<- nursery_data[-train.rows,] # 30% data goes in here
