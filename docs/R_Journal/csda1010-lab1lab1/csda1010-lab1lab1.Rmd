...
# Conclusion
Through exploring the Nursery Dataset and using a classification model to developed our algorithm to predict applicants suitabilty of an applicance admittance within the nursery school system, the evaluation of the model results indicated the following:
