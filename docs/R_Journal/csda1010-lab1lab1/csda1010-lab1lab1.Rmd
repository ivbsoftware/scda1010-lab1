...
The following code (Figure \ref{fig:classdp}) renders distribution of class attribute depending on parents attribute. ....
...
The following code (Figure \ref{fig:classdh}) renders distribution of class attribute depending on 'health' attribute. ...
