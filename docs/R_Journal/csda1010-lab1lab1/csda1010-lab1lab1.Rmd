...
```
Distribution of Class attribute presented in Figure2 \ref{fig:classd} shows the targeted varibles with five segments. The frequency of the segment "Recommend" is low (0.00015%) and will not be taken into consideration in the final dataset.
...
The following code (Figure \ref{fig:classdh}) renders distribution of class attribute depending on 'health' attribute. Being healthy is most important and relevant for parents to have their nursery application being recommended. 
...
```
The following code (Figure \ref{fig:classdi}) renders distribution of 'class' attribute depending on 'nursery' attribute.
